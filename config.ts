...
const schema = z.object({
  ...
  DEFAULT_TEXT_MODEL: z.string().default("gpt-5-mini"),
...
// Доступные модели для меню выбора (изменяй по желанию)
export const TEXT_MODELS = ["gpt-5", "gpt-5-mini", "gpt-5-nano"] as const;
